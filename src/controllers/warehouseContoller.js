...
exports.adjustQuantityHelper = async (kriptis, zingsnis, id) => {
    if (!zingsnis) {
...
// **New route handler for PATCH /:id/adjust**
exports.adjustQuantity = async (req, res, next) => {
    try {
        ...
        // Use helper internally
        const result = await exports.adjustQuantityHelper("+", quantity, id);
